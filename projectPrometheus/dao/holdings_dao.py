...
def showHoldings():
    query = "SELECT holdings.*, stockInfo.name, stockInfo.symbol FROM holdings INNER JOIN stockInfo ON holdings.stockInfoID = stockInfo.id ORDER BY holdings.dateBought DESC"
